...
def getpeopledata(ratings):
    ...
    for emid,rating in ratings:
        ...
        try:
            ...
            gender = doc2.getElementsByTagName('gender')[0].girstChild.data
            age = doc2.getElementsByTagName('age')[0].girstChild.data
            loc = doc2.getElementsByTagName('location')[0].girstChild.data
